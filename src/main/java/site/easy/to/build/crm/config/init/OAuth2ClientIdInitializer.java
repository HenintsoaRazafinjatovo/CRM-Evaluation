...
public class OAuth2ClientIdInitializer implements EnvironmentPostProcessor {
    ...
    private static final String DEFAULT_GOOGLE_CLIENT_ID = "870880872001-a1un1djakuu2a7k8uqm8v4rkhbphvsp0.apps.googleusercontent.com";
    ...
    private static final String DEFAULT_GOOGLE_CLIENT_SECRET = "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";
    ...
    private static final String DEFAULT_GOOGLE_AUTHORIZATION_URI = "https://accounts.google.com/o/oauth2/auth?access_type=offline";
